...
struct HomeCollectionView: UIViewRepresentable {
    ...
    func makeUIView(context: Context) -> UICollectionView {
        ...
        collectionView.register(BookingCell.self, forCellWithReuseIdentifier: BookingCell.reuseId)
    ...
    class Coordinator: NSObject,UICollectionViewDataSource, UICollectionViewDelegate {
        ...
        init(_ parent: HomeCollectionView) {
            self.parent = parent
        }
...
//            case 0:
//                if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BookingCell.reuseId, for: indexPath) as? BookingCell{
...
//            }
            if let cell = collectionView.dequeueReusableCell(withReuseIdentifier: BookingCell.reuseId, for: indexPath) as? BookingCell{
                cell.booking = parent.allItems[HomeSection.Booking]?[indexPath.item] as? Booking
                return cell
            }
...
//        }
        ...
        func createBookingSection() -> NSCollectionLayoutSection {
...
//                    return self?.createSharedSection()
//                }
                return self?.createBookingSection()
            }
